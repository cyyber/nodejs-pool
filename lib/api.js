    ...
    async.waterfall([
        function (callback) {
            ...
            return callback(null, {hash: cachedData.hash, identifier: 'global', lastHash: Math.floor(cachedData.lastHash / 1000),
                totalHashes: cachedData.totalHashes || 0, pplnsShares: Number(cachedData.pplnsShares) || 0, validShares: Number(cachedData.goodShares) || 0, invalidShares: Number(cachedData.badShares) || 0});
        },
...
if (cluster.isMaster) {
    ...
    app.listen(global.config.api_port, function () {
