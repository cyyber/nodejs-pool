...
function Coin(data){
    ...
    this.oldAlgorithmCheck = function(convertedBlob, badHash) {
        ...
        for (let i = blockVersion; i >= 1; i--) {
            ...
            if (lastVariant === null || cn_variant < lastVariant) {
                let hash = cnHashing.cryptonight(convertedBlob, cn_variant);
    ...
    this.variantShortName = function(blockHeight) {
        if (global.config.general.testnet === true) {
            if (blockHeight >= 1154318) {
                return "cn/r";
            } else if (blockHeight >= 1057058) {
                return "cn/2";
            } else if (blockHeight >= 1057027) {
                return "cn/1";
            } else {
                return "cn/0";
            }
        } else {
            if (blockHeight >= 1788000) {
                return "cn/r";
            } else if (blockHeight >= 1685555) {
                return "cn/2";
            } else if (blockHeight >= 1546000) {
                return "cn/1";
            } else {
                return "cn/0";
            }
