...
CREATE TABLE `balance` (
  ...
  `last_mine` timestamp NULL DEFAULT NULL,
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'address', '127.0.0.1', 'string', 'QRL Daemon RPC IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'port', '18090', 'int', 'QRL Daemon RPC Port');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'address', '127.0.0.1', 'string', 'QRL Daemon RPC Wallet IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'port', '18090', 'int', 'QRL Daemon RPC Wallet Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'exchangeMin', '25', 'float', 'Minimum QRL balance for payout to exchange/payment ID');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'walletMin', '5', 'float', 'Minimum QRL balance for payout to personal wallet');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'devDonation', '10', 'float', 'Donation to QRL core development');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'poolDevDonation', '10', 'float', 'Donation to pool developer');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'sigDivisor', '100000000', 'int', 'Divisor for turning coin into human readable amounts ');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feesForTXN', '10', 'int', 'Amount of QRL that is left from the fees to pay miner fees.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'maxTxnValue', '2500', 'int', 'Maximum amount of QRL to send in a single transaction');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'coinCode', 'QRL', 'string', 'Coincode to be loaded up w/ the shapeshift getcoins argument.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewAmount', '0.1', 'float', 'Amount to charge for the txn fee');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewEnd', '250', 'float', 'Value at which txn fee amount drops to 0');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'maxPaymentTxns', '25', 'int', 'Maximum number of transactions in a single payment');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'discordWebhook', '', 'string', 'Webhook path for Discord messages, this should be the part AFTER https://discordapp.com/api/webhooks/');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'discordBlockAnnounce', 'true', 'bool', 'Announce block finds in Discord');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'discordPayoutAnnounce', 'true', 'bool', 'Announce payout transactions in Discord');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pplns', 'minEffortRetention', '750', 'int', 'Minimum difficulty of worth of shares to retain, measured in round effort. This helps make sure that multiShare * difficulty worth of shares is available even when network difficulty is extemely volatile.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'maxConnectionsPerMiner', '50', 'int', 'The maximum simultaneous connections a single miner (payout address) is allowed to a given pool daemon.');
