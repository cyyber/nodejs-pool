...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'templateRefreshTime', '60', 'int', 'If the current active block template exceeds this age in seconds, a new template will be requested. If targetTime is below or too close to this value, pool side reported hashrates will be incredibly inaccurate.');
